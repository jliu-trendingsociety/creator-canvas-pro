...
export default function ProEditor() {
  ...
  return (
    <div className="h-screen w-full flex flex-col bg-background overflow-hidden">
      ...
      {/* Main Layout - Two-Level Structure */}
      <div className="flex flex-col w-full flex-1 overflow-hidden">
        
        {/* TOP AREA: Three-Column Editor */}
        <div className="flex flex-row w-full flex-1 overflow-hidden">
            ...
            <div className="flex-1 bg-background flex flex-col items-center justify-center p-4 md:p-8">
              {uploadedVideo ? (
                    ...
                    <div className="flex items-center gap-1 md:gap-4">
                      ...
                      <div className="flex items-center gap-1 md:gap-2">
                        ...
                        <Slider
                          ...
                          disabled={assetType !== "video"}
                          className="w-16 md:w-20 [&_[role=slider]]:border-neon [&_[role=slider]]:bg-neon disabled:opacity-30"
                        />
                      </div>
                      ...
                      <Button
                        ...
                        className={`text-foreground hover:text-neon hover:bg-neon/10 transition-all ${
                          showSafeFrames ? "bg-neon/20 text-neon" : ""
                        }`}
                      >
                ...
                <div className="text-center animate-in fade-in duration-500">
                  <div className="w-32 h-32 mx-auto mb-6 rounded-2xl bg-surface-elevated/50 border-2 border-dashed border-border/50 flex items-center justify-center">
          ...
          >
            <div className="p-6 space-y-6">
              ...
              <h3 className="text-xs font-bold text-neon tracking-wider">AI PROMPT</h3>
              
              <textarea
                placeholder="Describe the changes you want to make..."
                className="w-full h-40 p-4 rounded-lg bg-surface-elevated border border-border/50 text-foreground placeholder:text-muted-foreground resize-none focus:outline-none focus:ring-2 focus:ring-neon/50 transition-all"
              />

              <div className="space-y-2">
                <p className="text-xs text-muted-foreground">Suggested Prompts</p>
                <div className="flex flex-wrap gap-2">
                  {["Add slow motion", "Color grade", "Add transitions", "Stabilize", "Enhance quality"].map((prompt) => (
                    <button
                      key={prompt}
                      className="px-3 py-1.5 text-xs rounded-full bg-surface-elevated border border-border/50 hover:border-neon/50 hover:bg-neon/10 text-foreground transition-all"
                    >
                      {prompt}
                    </button>
                  ))}
              ...
              <div className="space-y-3">
                <Button className="w-full bg-neon text-background hover:bg-neon-glow font-bold transition-all hover:shadow-[0_0_20px_rgba(186,230,55,0.4)]">
                  <Sparkles className="w-4 h-4 mr-2" />
                  Generate Pro Video
                </Button>
                <Button 
                  variant="outline"
                  className="w-full border-border/50 text-foreground hover:border-neon/50 hover:bg-neon/10 transition-all"
